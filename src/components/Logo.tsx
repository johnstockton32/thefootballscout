...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(({
  ...
  return <div ref={ref} className={cn('flex items-center gap-3 mt-[3px]', className)}>
        <img alt="The Football Scout" className={cn('object-contain rounded-full', iconSizes[size])} src="/lovable-uploads/5a101acd-d7bc-4080-95eb-fc7b6e85f5ca.png" />
